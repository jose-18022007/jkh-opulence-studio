      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          <div
            ...
            style={{ aspectRatio: '16/10', border: '2px solid rgba(198,165,92,0.2)', boxShadow: '0 0 60px rgba(198,165,92,0.08)' }}
          >
            {/* Before */}
            <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, #2a2a3a, #1a1a2a, #252535)' }} />
            <div className="absolute top-4 left-4 z-10 px-3 py-1 rounded-full text-[12px] font-inter uppercase tracking-[3px] text-white/80" style={{ background: 'rgba(0,0,0,0.5)' }}>Before</div>
            {/* After */}
            <div className="absolute inset-0" style={{ clipPath: `inset(0 0 0 ${pos}%)`, background: 'linear-gradient(135deg, #1a1a2e, #2a1f3d, #C6A55C22)' }} />
            <div className="absolute top-4 right-4 z-10 px-3 py-1 rounded-full text-[12px] font-inter uppercase tracking-[3px]" style={{ background: 'linear-gradient(135deg, #C6A55C, #E8D5A3)', color: '#08080F' }}>After</div>
            {/* Slider */}
            ...
            {thumbnails.map(t => (
              ...
              >
                <div className="flex gap-0.5">
                  <div className="w-[60px] h-[40px] md:w-[120px] md:h-[80px] rounded-lg" style={{ background: 'linear-gradient(135deg, #2a2a3a, #1a1a2a)', border: '1px solid rgba(255,255,255,0.08)' }} />
                  <div className="w-px gold-gradient-bg opacity-40" />
                  <div className="w-[60px] h-[40px] md:w-[120px] md:h-[80px] rounded-lg" style={{ background: 'linear-gradient(135deg, #1a1a2e, #C6A55C11)', border: '1px solid rgba(255,255,255,0.08)' }} />
                </div>
