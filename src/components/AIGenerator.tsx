      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div
            ...
            className="py-14 px-6 text-center transition-all duration-300"
            style={{
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full mt-10 gold-gradient-bg text-dark-primary font-playfair text-xl font-bold py-5 cursor-pointer animate-pulse-gold"
